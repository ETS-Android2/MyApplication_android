...
import vn.edu.stu.myapplication.SanPhamActivity;
...
public class LoaiAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.loai_sanpahm, null);
    ...
    private void del_Option(Loai l) {
        ...
        if (loaitc == null || loaitc.equals("")) {
            ...
            builder.setPositiveButton(R.string.Yes, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent1 = new Intent(context, SanPhamActivity.class);
